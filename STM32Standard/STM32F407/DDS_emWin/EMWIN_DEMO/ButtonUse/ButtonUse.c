						...
						case WM_NOTIFICATION_RELEASED:
							if(DDS_mode==1) //调频
							{
								if(num<100000000)//100M以上设置失败
								{
									...
									//SPI发送
									SPI_FPGA_Write_cmd(DDS_mode);//模式
									SPI_FPGA_Write_data((u16)Frequency);//频率
//									SPI_FPGA_Write_data(0x0123);
//									SPI_FPGA_Write_data(0x4567);
//									SPI_FPGA_Write_data(0x0);
//									SPI_FPGA_Write_data(0x7);//7
//									SPI_FPGA_Write_data(0x1);
//									SPI_FPGA_Write_data(0x86A0);//100K
//									SPI_FPGA_Write_data(0x0);
//									SPI_FPGA_Write_data(0xB4);//180
//									SPI_FPGA_Write_data(0x89ab);
//									SPI_FPGA_Write_data(0xcdef);
								}
								else
								{
