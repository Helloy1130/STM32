...
extern u32 fbase_cnt;  //标准信号频率计数值
extern u32 fx_cnt;     //待测信号频率计数值 
extern u32 time_cnt;   //双通道同频率信号的时间间隔计数值
extern u32 duty_cnt;   //待测信号占空比计数值
extern u8 end_flag;	//结束标志0xff
extern u8 check_flag1;	//校验码0x0a
extern u8 check_flag2;	//校验码0x0a 
...
//					printf("time_cnt: %d\r\n",time_cnt);
		...
		OSTimeDlyHMSM(0,0,0,50,OS_OPT_TIME_PERIODIC,&err);//延时100ms
	}
}
