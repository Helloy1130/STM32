...
#define		SPI4_DATA_WIDTH 16	//定义发送数据的宽度---注意:如果要更改数据位宽,对应的发送和接收数据程序也要更改
...
// SPI2读写函数
extern void SP2_Send_Data(u16 Send_Data);
...
// SPI4读写函数
extern void SPI4_Write_Byte(u16 Data);
extern u16 SPI4_Read_Byte(void);
extern u16 SPI4_Write_Read(u16 Digital);
