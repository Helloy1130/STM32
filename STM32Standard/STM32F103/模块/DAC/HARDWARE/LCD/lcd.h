...
void LCD_ShowString_hanzi1(int x,u16 y,u16 width,u16 height,u8 size,char *p);//显示汉字
void LCD_ShowChar_hanzi1(int x,u16 y,u8 num,u8 size,u8 mode);				//显示1个汉字
