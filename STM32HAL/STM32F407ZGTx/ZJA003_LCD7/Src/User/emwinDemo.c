...
#define ID_TEXT_21      (GUI_ID_USER + 0x1E)
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] =
{
        ...
        { TEXT_CreateIndirect, "Text", ID_TEXT_17, 600, 260, 40, 40, 0, 0x64, 0 },
        { TEXT_CreateIndirect, "Text", ID_TEXT_18, 635, 260, 40, 40, 0, 0x64, 0 },
        { TEXT_CreateIndirect, "Text", ID_TEXT_19, 670, 260, 40, 40, 0, 0x64, 0 },
        { TEXT_CreateIndirect, "Text", ID_TEXT_20, 700, 260, 40, 40, 0, 0x64, 0 },
        { TEXT_CreateIndirect, "Text", ID_TEXT_21, 730, 260, 40, 40, 0, 0x64, 0 },
...
//                if (WM_IsCompletelyCovered(WM_GetDialogItem(pMsg->hWin, ID_GRAPH_0))) break;//当切换到其他页面什么都不做
                ...
                for (int i = 1; i < FFT_LENGTH / 4; ++i) {
                    ...
                    //标出频率
                    if (fft_outputbuf[8] > 100) {
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_8), "1kHz");
                    }
                    else{
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_8), "");
                    }
                    if (fft_outputbuf[8*2] > 6) {
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_9), "2kHz");
                    }
                    else{
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_9), "");
                    }
                    if (fft_outputbuf[8*3] > 6) {
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_10), "3kHz");
                    }
                    else{
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_10), "");
                    }
                    if (fft_outputbuf[8*4] > 6) {
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_11), "4kHz");
                    }
                    else{
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_11), "");
                    }
                    if (fft_outputbuf[8*5] > 6) {
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_12), "5kHz");
                    }
                    else{
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_12), "");
                    }
                    if (fft_outputbuf[8*6] > 6) {
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_17), "6kHz");
                    }
                    else{
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_17), "");
                    }
                    if (fft_outputbuf[8*7] > 6) {
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_18), "7kHz");
                    }
                    else{
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_18), "");
                    }
                    if (fft_outputbuf[8*8] > 6) {
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_19), "8kHz");
                    }
                    else{
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_19), "");
                    }
                    if (fft_outputbuf[8*9] > 6) {
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_20), "9kHz");
                    }
                    else{
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_20), "");
                    }
                    if (fft_outputbuf[8*10] > 6) {
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_21), "10kHz");
                    }
                    else{
                        TEXT_SetText(WM_GetDialogItem(hWin, ID_TEXT_21), "");
                    }
