...
/*INPUT*/
#define PEN  		    FT_INT  	        //T_PEN
//#define DOUT 		    PBin(2)   	        //T_MISO
/*OUTPUT*/
#define TDIN_HIGH 		CT_IIC_SDA_HIGH  	//T_MOSI
#define TDIN_LOW 		CT_IIC_SDA_LOW  	//T_MOSI
#define TCLK_HIGH 		CT_IIC_SCL_HIGH  	//T_SCK
#define TCLK_LOW 		CT_IIC_SCL_LOW  	//T_SCK
#define TCS_HIGH 	    FT_RST_HIGH  	    //T_CS
#define TCS_LOW 		FT_RST_LOW  	    //T_CS
