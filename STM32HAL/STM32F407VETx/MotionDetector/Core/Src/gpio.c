...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, W25QXX_CS_Pin|DigitalTube_SER_Pin|DigitalTube_DISEN_Pin|DigitalTube_A1_Pin
                          |DigitalTube_A2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PCPin PCPin PCPin PCPin
                           PCPin */
  GPIO_InitStruct.Pin = W25QXX_CS_Pin|DigitalTube_SER_Pin|DigitalTube_DISEN_Pin|DigitalTube_A1_Pin
                          |DigitalTube_A2_Pin;
